...
export function TooltipContent() {
  ...
  <b>Retrieval-Augmented Generation</b> React frontend, Express.js as the backend API layer, LangChain for orchestrating the Retrieval-Augmented Generation pipeline, and Qdrant as the vector database for semantic search.        {/* <Tooltip
      ...
      <div className=" text-neutral-600 text-sm text-pretty ">
        ...
        <b>Video Conferencing Application</b>{" "}
A real-time full-stack application built with React on the frontend integrated with the Stream API for live video, screen sharing, and multi-participant session management. The backend handled JWT-based authentication, session state, and fault-tolerant reconnection logic
      </div>
      ...
      <div className=" text-neutral-600 text-sm text-pretty ">
        ...
        <b>AI Face Detection</b>  Machine learning classification model to a live web interface, handling input preprocessing, model inference, and output rendering.
      </div>
      <div className=" text-neutral-600 text-sm text-pretty ">
        {/* <Tooltip
          containerClassName="text-neutral-600 text-sm "
...
<b>Snake Game</b>{" "}
JavaScript based game itself but the architecture decisions: modular OOP design, reusable components, and configurable parameters      </div>
