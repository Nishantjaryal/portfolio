  ...
  return (
    <div>
      ...
      ">
        ...
        <span className={`inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg  shadow-2xl  px-7 text-sm font-medium text-neutral-700 backdrop-blur-3xl gap-3 ${otherClasses}`}
        onClick={handleClick}
        >
            {position ==="left" && icon}
          {title}
