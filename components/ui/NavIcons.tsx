...
import { MdContactMail, MdImportContacts } from "react-icons/md";
...
const NavIcons = () => {
  const navItems = [
    ...
    },
    {
      ...
      name: "Certifications",
      link: "/achievements",
      icon: <MdImportContacts className="h-4 w-4 text-muted-foreground" />,
    },

    {
      name: "Resume",
      link: "https://drive.google.com/file/d/1hXAKKoNFSK1Ug7yNTPgb2VkmCmADVf66/view?usp=sharing",
      icon: <MdContactMail className="h-4 w-4 text-muted-foreground" />,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <a
        href="https://www.linkedin.com/in/nishant-singh-jaryal/"
        target="_blank"
      >
